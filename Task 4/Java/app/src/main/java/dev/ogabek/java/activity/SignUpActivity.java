...
public class SignUpActivity extends BaseActivity {
    ...
    private void initViews() {
        ...
        b_signup.setOnClickListener(view -> {
            firebaseSignUp(et_email.getText().toString(), et_password.getText().toString());
        });
    ...
    private void firebaseSignUp(String email, String password) {
        ...
        AuthManager.signUp(email, password, new AuthHandler() {
            ...
            public void onError(Exception exception) {
                dismissLoading();
                Toast.makeText(context, "Sign Up Failed" + exception.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
